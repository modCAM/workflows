...
# file licenses/BSD-3-Clause for details.
...
.. command:: sphinx_build
  ...
  documentation with Sphinx. If you are using this function with Breathe to
  generate Sphinx-style docs from Doxygen, then you should add the
  :command:`doxygen_add_docs` target as a dependency to this command's target.
  ...
  This function is basically a CMake interface for the sphinx-build command
  provided by the Sphinx documentation generation tool. You can provide options,
  a source directory, and an output directory just like you would if you called
  sphinx-build directly.

  ``ALL``
    If set, the target will be added to the default build target.

  ``OPTIONS``
    These options should be specified exactly as you would write them for
	sphinx-build. You can specify all options in one string, or you can split
	options across multiple strings.

  ``SOURCE_DIR``
    sphinx-build will generate documentation from the files in this directory.

  ``OUTPUT_DIR``
    The generated documentation is placed in this directory.
